...
<div class="max-w-5xl mx-auto space-y-6">
  <div class="flex items-center gap-4">
    ...
    <div>
      <h1 class="text-2xl font-bold text-slate-900">Catat Nota Pembelian</h1>
  ...
  <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden p-4 sm:p-6">
    ...
    <form onsubmit={(e) => { e.preventDefault(); state.submitInvoice(); }} class="space-y-6">
      ...
      <div class="pt-6 flex justify-end gap-3">
        <a href={`/inventory/purchasing/${state.order?.id}`} class="px-6 py-2 text-slate-600 font-medium hover:bg-slate-50 rounded-lg transition-colors">Batal</a>
