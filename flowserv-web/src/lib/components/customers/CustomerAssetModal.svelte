    ...
    <div class="bg-white rounded-xl shadow-xl max-w-md w-full p-6">
      ...
      <div class="space-y-4">
        ...
        <div>
          ...
          <input id="brand" type="text" bind:value={state.newAsset.brand} class="w-full px-4 py-2 border border-slate-200 rounded-lg outline-none focus:ring-2 focus:ring-blue-500" placeholder="mis. Samsung">
        </div>
        <div>
          <label class="block text-sm font-medium text-slate-700 mb-1" for="model">Model</label>
          <input id="model" type="text" bind:value={state.newAsset.model} class="w-full px-4 py-2 border border-slate-200 rounded-lg outline-none focus:ring-2 focus:ring-blue-500" placeholder="mis. Galaxy S21">
        </div>
        <div>
