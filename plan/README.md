...
| [`R2-halaman-tiket-per-peran.md`](R2-halaman-tiket-per-peran.md) | **Rencana kerja fase yang sedang jalan** — R2.1 pecah komponen → R2.2 lapisan per peran → R2.4 gerbang tahap → R2.3 tes | 🟢 **AKTIF, dibuka 2026-08-06** |
| [`R1.11-perbaikan-hasil-uji-R1.10.md`](R1.11-perbaikan-hasil-uji-R1.10.md) | Rencana **+ bukti** fase R1.11 — T1–T5 dari catatan uji R1.10 pemilik (poin A7 & A8) | ✅ Selesai & sudah diuji pemilik |
| [`uji-R1.11-perbaikan.md`](uji-R1.11-perbaikan.md) | Checklist uji R1.11 — **sudah diisi pemilik** 2026-08-06 (**18/18 `OK`**, commit `d83dc44`); membuka gerbang R2 | ✅ Terisi |
...
R1.11 Perbaikan hasil uji R1.10   ✅ SELESAI 2026-08-06 — sudah diuji pemilik (18/18 OK, TAK ADA yang gagal)
R2   Halaman tiket per peran      🟢 SEDANG DIKERJAKAN sejak 2026-08-06 (R2-halaman-tiket-per-peran.md)
